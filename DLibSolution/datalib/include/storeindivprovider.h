...
namespace info {
	...
	/////////////////////////////////////////
	class SerialStoreIndivProvider : public StoreIndivProvider, public ISerialIndivProvider, private boost::noncopyable {
	private:
		size_t  m_current;
		boost::mutex _mutex;
	public:
		...
		SerialStoreIndivProvider(IStoreHelper *pHelper, const std::wstring &setName);
	public:
