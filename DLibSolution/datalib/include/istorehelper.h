...
namespace info {
	...
	public:
		...
		virtual bool find_all_datasets(std::vector<DBStatDataset> &oList, int skip = 0, int count = DATATRANSFER_CHUNK_SIZE) = 0;
		virtual bool find_all_datasets_ids(std::vector<IntType> &oList, int skip = 0, int count = DATATRANSFER_CHUNK_SIZE) = 0;
